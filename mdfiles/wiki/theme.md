...
ランサムウェアに感染した場合，ファイルのデータが暗号化され，業務の継続が困難になり多額の損害が生じます. また，企業イメージの低下などの2次被害も甚大です．  
しかし，Linuxなどで用いられるファイルシステムにはバージョン管理機能がなく，ファイルのデータを暗号化や削除された場合，データを復元することは困難です．  
適切にデータのバックアップを行っていれば，ほとんどのデータを取り戻すことは可能ですが，バックアップが完了してから攻撃されるまでに生じたファイルの変更が消失してしまいます．  
本研究では，ファイルに対する書き込みを自動でバージョン管理することによって，ランサムウェアによる攻撃被害にあったとしても，即座にデータの復元ができることを目的としています．  
